        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = 0; j < s; j++) {
                if (prtsize.get(j) >= processs[i]) {
                    ...
                    else if (prtsize.get(bestIdx) > prtsize.get(j) ) {
                        bestIdx = j;
